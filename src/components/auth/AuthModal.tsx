          ...
          <div className="flex bg-white/10 rounded-lg p-1">
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-all ${
                tab === 'login' ? 'bg-white text-blue-900 shadow-sm' : 'text-white/80 hover:text-white'
              }`}
            >
              Iniciar Sesión
            </button>
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-all ${
                tab === 'register' ? 'bg-white text-blue-900 shadow-sm' : 'text-white/80 hover:text-white'
              }`}
            >
              Registrarse
            </button>
          ...
          {tab === 'login' ? (
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-medium hover:from-blue-700 hover:to-indigo-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {roleOptions.map(opt => (
                    ...
                    >
                      <div className={`mb-1 ${regRole === opt.value ? 'text-blue-600' : 'text-gray-400'}`}>
                        {opt.icon}
                      </div>
                      <div className={`text-sm font-medium ${regRole === opt.value ? 'text-blue-900' : 'text-gray-700'}`}>
                        {opt.label}
                      </div>
